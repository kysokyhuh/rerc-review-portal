...
router.put("/projects/:id/profile", (0, auth_1.requireRoles)([client_1.RoleType.ADMIN, client_1.RoleType.CHAIR, client_1.RoleType.RESEARCH_ASSOCIATE]), async (req, res) => {
    try {
        const projectId = Number(req.params.id);
        if (Number.isNaN(projectId)) {
            return res.status(400).json({ message: "Invalid project id" });
        ...
        const profile = await prismaClient_1.default.protocolProfile.upsert({
            where: { projectId },
            update: data,
            create: {
                projectId,
...
router.post("/projects/:id/profile/milestones", (0, auth_1.requireRoles)([client_1.RoleType.ADMIN, client_1.RoleType.CHAIR, client_1.RoleType.RESEARCH_ASSOCIATE]), async (req, res) => {
    try {
        const projectId = Number(req.params.id);
        if (Number.isNaN(projectId)) {
            return res.status(400).json({ message: "Invalid project id" });
        ...
        const created = await prismaClient_1.default.protocolMilestone.create({
            data: {
                projectId,
                label,
...
router.patch("/projects/:id/profile/milestones/:milestoneId", (0, auth_1.requireRoles)([client_1.RoleType.ADMIN, client_1.RoleType.CHAIR, client_1.RoleType.RESEARCH_ASSOCIATE]), async (req, res) => {
    try {
        const projectId = Number(req.params.id);
        ...
        const existing = await prismaClient_1.default.protocolMilestone.findUnique({
        ...
        const updated = await prismaClient_1.default.protocolMilestone.update({
            where: { id: milestoneId },
            data: {
                ...
                dateOccurred: req.body?.dateOccurred === undefined
                    ? undefined
                    : asNullableDate(req.body?.dateOccurred),
                ownerRole: req.body?.ownerRole === undefined
                    ? undefined
...
router.delete("/projects/:id/profile/milestones/:milestoneId", (0, auth_1.requireRoles)([client_1.RoleType.ADMIN, client_1.RoleType.CHAIR, client_1.RoleType.RESEARCH_ASSOCIATE]), async (req, res) => {
    try {
        const projectId = Number(req.params.id);
        const milestoneId = Number(req.params.milestoneId);
        if (Number.isNaN(projectId) || Number.isNaN(milestoneId)) {
        ...
        await prismaClient_1.default.protocolMilestone.delete({
            where: { id: milestoneId },
        });
