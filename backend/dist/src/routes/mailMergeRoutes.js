...
router.get("/mail-merge/initial-ack.csv", async (req, res) => {
    try {
        ...
        for (const submission of submissions) {
            ...
            rows.push([
                (0, csvUtils_1.csvEscape)(project.projectCode),
                (0, csvUtils_1.csvEscape)(project.title),
                (0, csvUtils_1.csvEscape)(project.piName),
                (0, csvUtils_1.csvEscape)(project.piAffiliation),
                (0, csvUtils_1.csvEscape)(committee?.code ?? ""),
                (0, csvUtils_1.csvEscape)(committee?.name ?? ""),
                (0, csvUtils_1.csvEscape)(submission.submissionType),
                (0, csvUtils_1.csvEscape)(classification?.reviewType ?? ""),
                (0, csvUtils_1.csvEscape)(submission.receivedDate),
                (0, csvUtils_1.csvEscape)(classification?.classificationDate ?? ""),
                (0, csvUtils_1.csvEscape)(letterDate),
                (0, csvUtils_1.csvEscape)(ra?.fullName ?? ""),
                (0, csvUtils_1.csvEscape)(ra?.email ?? ""),
            ].join(","));
        }
    ...
    try {
        ...
        for (const submission of submissions) {
            ...
            rows.push([
                ...
                (0, csvUtils_1.csvEscape)(submission.submissionType),
                (0, csvUtils_1.csvEscape)(classification?.reviewType ?? ""),
                (0, csvUtils_1.csvEscape)(submission.finalDecision ?? ""),
                (0, csvUtils_1.csvEscape)(submission.finalDecisionDate ?? ""),
                (0, csvUtils_1.csvEscape)(project.approvalStartDate ?? ""),
                (0, csvUtils_1.csvEscape)(project.approvalEndDate ?? ""),
                (0, csvUtils_1.csvEscape)(letterDate),
                (0, csvUtils_1.csvEscape)(ra?.fullName ?? ""),
                (0, csvUtils_1.csvEscape)(ra?.email ?? ""),
            ].join(","));
