...
export type NullableEnumReviewerRoleTypeFieldUpdateOperationsInput = {
  set?: $Enums.ReviewerRoleType | null
}

export type EnumHonorariumStatusFieldUpdateOperationsInput = {
